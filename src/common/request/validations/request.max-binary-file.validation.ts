  ...
  /!*validate(value: string, args: ValidationArguments): boolean {
    ...
    switch (type) {
      case ENUM_FILE_TYPE.AUDIO:
        fileSize = this.configService.get<number>('file.audio.maxFileSize');
        break;
      case ENUM_FILE_TYPE.EXCEL:
        fileSize = this.configService.get<number>('file.excel.maxFileSize');
        break;
      case ENUM_FILE_TYPE.IMAGE:
        fileSize = this.configService.get<number>('file.image.maxFileSize');
        break;
      case ENUM_FILE_TYPE.VIDEO:
        fileSize = this.configService.get<number>('file.video.maxFileSize');
        break;
      default:
        break;
    }
